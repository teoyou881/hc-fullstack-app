...
const App = () => {
  const {user, isAuthenticated, loading, authChecked, checkLoginStatus, forceLogout} = useUserStore();
  ...
  }, [checkLoginStatus, authChecked, navigate]);
        ...
        <Routes>
          ...
          <Route element={<PrivateRoute isAuthenticated={isAuthenticated}
            ...
            <Route path="/admin/*" element={<AdminLayout/>}>
              ...
              <Route path="products/:productId/sku"
                     element={<AdminSkuListPage/>}/>
